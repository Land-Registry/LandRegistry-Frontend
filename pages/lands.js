                        ...
                        <div className="m-auto text-center">
                          ...
                          >
                            3D Land View
                                                 ...
                                                 <Button type="primary" loading={loadings[0]} onClick={() =>RequestLand()} className="bg-blue-500 w-[46%] hover:bg-blue-700 text-white font-bold py-2 h-auto px-4 mx-2 rounded my-2 text-[16px]">
